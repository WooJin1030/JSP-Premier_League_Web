...
public class LeicesterPlayerManager {
	
	private List<LeaugePlayerBean> pList = new ArrayList<LeaugePlayerBean>();
	
	private static LeicesterPlayerManager instance = new LeicesterPlayerManager();
	
	public static LeicesterPlayerManager getInstance(){
		return instance;
	}
	
	public LeicesterPlayerManager() {
		
		LeicesterPlayerData data = new LeicesterPlayerData();
		JSONArray memberArray = data.getLeicesterPlayerArray();
